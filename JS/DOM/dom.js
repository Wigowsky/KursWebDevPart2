...
document.querySelectorAll(".even"); // sposób jak wyciągnąć po class name przez querySelector
...
// firstLi.classList.toggle("space"); //przełączanie (jak nie ma dodaje, jak jest usuwa)
